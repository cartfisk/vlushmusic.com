...
1) validate whether **you** think your idea is good
2) effectively express & communicate your idea
3) validate others' understanding of your idea
4) validate whether **others** think your idea is good
5) achieve alignment on pursuing your idea
...
Too many rules can throw off the vibe. Re-framing structure as a challenge in the form of a game allows for implementing focus without the oppressiveness of "studio rules".

**Democratize the pursuit of ideas**
Inexperienced artists/producers should have a chance to express their ideas without having to feel pushy or aggressive. Shy or quiet people should be given a chance to contribute. The game addresses this by giving all players a turn to steer the ship and choose which ideas to pursue.
...
Timed turns ensure no one spends too much time attempting to execute a long-winded idea. Studio tangents often lead to loss of focus, momentum, etc. Beyond the hard time limit, the game forces Producers to be considerate of how much time a given task requires.
...
- Timer
- [Die](https://share.google/SGtSlslNPyTgwowWj)
...
3. **The player matching the number rolled becomes The Producer.**
...
5. **For pre-existing sessions, ensure a snapshot of the DAW session exists and a 2-track bounce has been exported.**

6. **Agree on turn length**
...
2. **After 20 minutes–**
    ...
    - a 2-track is bounced out labelled with the current Producer's name
    ***never save DAW sessions destructively***

3. **Retrospective period begins** (~5 minutes)
...
4. **Vote on Producer switch** (Optional, 1 minute)
...
7. **When the session is over, all revisions of 2-track bounces are distributed to each player**
...
If you end up playing, [let me know how it goes](mailto:vlush@vlushmusic.com?subject=Wild%2020's).
